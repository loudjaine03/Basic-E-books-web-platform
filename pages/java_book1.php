...
<body>
  ...
  <section class="container1">
    <div class="text-content">
      ...
      <form action="../assets/java/Book 1.pdf">
      <button> Read here</button>
      </form>
      <p >Explore other JAVA books <a href="java.php"> Here</a></p>
    </div>
    <div class="book-info">  <img src="../assets/java/photo 1.jpg" alt="Book 1" height="120" width="80">
      <h4>100+ Java Programs with Output- Useful collection of Java Programs</h4>
