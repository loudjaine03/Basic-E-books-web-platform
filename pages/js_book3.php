...
<body>
  ...
  <section class="container1">
    <div class="text-content">
      ...
      <form action="../assets/js/Book 3.pdf">
      <button> Read here</button>
      </form>
      <p>Explore other JS books <a href="js.php"> Here</a></p>
    </div>
    <div class="book-info">  <img src="../assets/js/photo 3.jpg"  height="120" width="80">
      <h4>Functional Programming in JavaScript- How to improve your JavaScript programs</h4>
