...
<body>
  ...
  <section class="container1">
    <div class="text-content">
      ...
      <form action="../assets/java/Book 2.pdf">
      <button> Read here</button>
      </form>
      <p>Explore other JAVA books <a href="java.php"> Here</a></p>
    </div>
    <div class="book-info">  <img src="../assets/java/photo 2.jpg" height="120" width="80">
      <h4>Easy Java Programming for Beginners, Your Step-By-Step Guide to Learning Java Programming</h4>
