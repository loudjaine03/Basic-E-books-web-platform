...
<body>
  ...
  <section class="container1">
    <div class="text-content">
      ...
      <form action="../assets/python/Book 3.pdf">
      <button> Read here</button>
      </form>
      <p>Explore other Python books <a href="python.php"> Here</a></p>
    </div>
    <div class="book-info">  <img src="../assets/python/photo 3.jpg"  height="120" width="80">
      <h4>Python Programming for Beginners, Python Programming for Intermediates</h4>
    </div>
  </section>
