...
<body>
  ...
  <section class="container1">
    <div class="text-content">
      ...
      <form action="../assets/php/Book 4.pdf">
      <button> Read here</button>
      </form>
      <p>Explore other PHP books <a href="php.php"> Here</a></p>
    </div>
    <div class="book-info">  <img src="../assets/php/photo 4.jpg"  height="120" width="80">
      <h4>PHP Crush Course! Learn PHP Programming in 4 hours!</h4>
    </div>
  </section>
