...
<body>
  ...
  <section class="container1">
    <div class="text-content">
      ...
      <form action="../assets/java/Book 3.pdf">
      <button> Read here</button>
      </form>
      <p>Explore other Java books <a href="java.php"> Here</a></p>
    </div>
    <div class="book-info">  <img src="../assets/java/photo 3.jpg" height="120" width="80">
      <h4>Java for Absolute Beginners- Learn to Program the Fundamentals the Java 9+ Way</h4>
