...
<body>
  ...
  <section class="container1">
    <div class="text-content">
      ...
      <form action="../assets/php/Book 1.pdf">
      <button> Read here</button>
      </form>
      <p>Explore other PHP books <a href="js.php"> Here</a></p>
    </div>
    <div class="book-info">  <img src="../assets/php/photo 1.jpg"  height="120" width="80">
      <h4>Acodemy. Php- Learn PHP In A DAY!</h4>
    </div>
  </section>
