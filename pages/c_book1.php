...
<body>
  ...
  <section class="container1">
    <div class="text-content">
      ...
      <form action="../assets/c/Book 1.pdf">
      <button> Read here</button>
      </form>
      <p>Explore other C books <a href="c.php"> Here</a></p>
    </div>
    <div class="book-info">  <img src="../assets/c/photo1.jpg" alt="Book 1" height="120" width="80">
      <h4>C Programming Language: The Ultimate Beginner's Guide</h4>
